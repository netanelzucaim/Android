...
class AddStudentActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val nameEditText: TextView = findViewById(R.id.add_student_activity_name_edit_text)
        val idEditText: TextView = findViewById(R.id.add_student_activity_id_edit_text)
